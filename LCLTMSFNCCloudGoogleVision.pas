...
unit LCLTMSFNCCloudGoogleVision;
...
uses
  Classes, SysUtils, Types, LCLTMSFNCCloudOAuth, LCLTMSFNCCloudBase, LCLTMSFNCTypes, LCLTMSFNCUtils
  {$IFDEF WEBLIB}
...
constructor TTMSFNCCloudGoogleVisionDetectedObject.Create(ACollection: TCollection);
begin
  inherited;
  FName := EmptyStr;
  FConfidence := 0;
...
constructor TTMSFNCCloudGoogleVisionResponse.Create(ACollection: TCollection);
begin
  inherited;
...
constructor TTMSFNCCloudGoogleVisionLabel.Create(ACollection: TCollection);
begin
  inherited;
...
constructor TTMSFNCCloudGoogleVisionLogo.Create(ACollection: TCollection);
begin
  inherited;
  FDescription := EmptyStr;
  FScore := 0;
...
constructor TTMSFNCCloudGoogleVisionLandmark.Create(ACollection: TCollection);
begin
  inherited;
  FDescription := EmptyStr;
  FScore := 0;
...
constructor TTMSFNCCloudGoogleVisionWebEntity.Create(ACollection: TCollection);
begin
  inherited;
  FDescription := EmptyStr;
  FScore := 0;
...
constructor TTMSFNCCloudGoogleVisionWebImagePageMatch.Create(ACollection: TCollection);
begin
  inherited;
  FPageURL := EmptyStr;
...
constructor TTMSFNCCloudGoogleVisiondetectedText.Create(ACollection: TCollection);
begin
  inherited;
  FDescription := EmptyStr;
  FLanguage := EmptyStr;
...
constructor TTMSFNCCloudGoogleVisionDetectedFace.Create(ACollection: TCollection);
begin
  inherited;
...
constructor TTMSFNCCloudGoogleVisionFaceLandmark.Create(ACollection: TCollection);
begin
  inherited;
  FName := EmptyStr;
  FPoint := PointF(0,0);
