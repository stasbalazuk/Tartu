...
var
   ...
   PEM_read_PrivateKey: function(var fp: FILE; x: PPEVP_PKEY; cb: pem_password_cb; u: pointer): PEVP_PKEY; cdecl = nil;
  ...
  PEM_read_PUBKEY: function (var fp: FILE; x: PPEVP_PKEY; cb: pem_password_cb; u: pointer): PEVP_PKEY; cdecl = nil;
...
{$REGION 'RSA'}
  ...
  PEM_read_RSAPublicKey: function(var fp: FILE; x: PPRSA; cb: pem_password_cb; u: pointer): PRSA; cdecl = nil;
  ...
  PEM_read_RSA_PUBKEY: function(var fp: FILE; x: PPRSA; cb: pem_password_cb; u: pointer): PRSA; cdecl = nil;
...
{$REGION 'DSA'}
 ...
 PEM_read_DSAPrivateKey: function(var fp: FILE; x: PPDSA; cb: pem_password_cb; u: pointer): PDSA; cdecl = nil;
 ...
 PEM_read_DSA_PUBKEY: function(var fp: FILE; x: PPDSA; cb: pem_password_cb; u: pointer): PDSA; cdecl = nil;
 ...
 PEM_read_DSAparams: function(var fp: FILE; x: PPDSA; cb: pem_password_cb; u: pointer): PDSA; cdecl = nil;
...
{$REGION 'DH'}
 ...
 PEM_read_DHparams: function(var fp: FILE; x: PPDH; cb: pem_password_cb; u: pointer): PDH; cdecl = nil;
...
{$REGION 'X509'}
 ...
 PEM_read_X509: function(var fp: FILE; x: PPX509; cb: pem_password_cb; u: pointer): PX509; cdecl = nil;
 ...
 PEM_read_X509_AUX: function(var fp: FILE; x: PPX509; cb: pem_password_cb; u: pointer): PX509; cdecl = nil;
 ...
 PEM_read_X509_REQ: function(var fp: FILE; x: PPX509_REQ; cb: pem_password_cb; u: pointer): PX509_REQ; cdecl = nil;
 ...
 PEM_read_X509_CRL: function(var fp: FILE; x: PPX509_CRL; cb: pem_password_cb; u: pointer): PX509_CRL; cdecl = nil;
...
{$REGION 'PKCS7}
 ...
 PEM_read_PKCS7: function(var fp: FILE; x: PPPKCS7; cb: pem_password_cb; u: pointer): PPKCS7; cdecl = nil;
...
{$REGION 'NETSCAPE'}
 PEM_read_bio_NETSCAPE_CERT_SEQUENCE: function(bp: PBIO; x: PPNETSCAPE_CERT_SEQUENCE; cb: pem_password_cb; u: pointer): PNETSCAPE_CERT_SEQUENCE; cdecl = nil;
 PEM_read_NETSCAPE_CERT_SEQUENCE: function(var fp: FILE; x: PPNETSCAPE_CERT_SEQUENCE; cb: pem_password_cb; u: pointer): PNETSCAPE_CERT_SEQUENCE; cdecl = nil;
