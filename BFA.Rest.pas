...
const
  {$IF DEFINED(IOS) or DEFINED(ANDROID)}
      ...
      AURLFile = 'https://www.blangkon.net/';
  {$ELSE}
      AURL = 'http://localhost/upload.php';
      AURLFile = 'https://www.blangkon.net/';
  {$ENDIF}
...
begin
  ...
  mem.FieldDefs.Add('status', ftString, 200, False);
  mem.FieldDefs.Add('messages', ftString, 200, False);
  mem.FieldDefs.Add('data', ftString, 200, False);
