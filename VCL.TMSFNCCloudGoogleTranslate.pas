...
unit VCL.TMSFNCCloudGoogleTranslate;
...
uses
  Classes, VCL.TMSFNCCloudOAuth, VCL.TMSFNCCloudBase, VCL.TMSFNCTypes, VCL.TMSFNCUtils
  {$IFDEF WEBLIB}
...
constructor TTMSFNCCloudGoogleTranslateTranslation.Create(Collection: TCollection);
begin
  inherited;
  FSourceLanguage := '';
  FTranslatedText := '';
...
constructor TTMSFNCCloudGoogleTranslateDetection.Create(Collection: TCollection);
begin
  inherited;
  FSourceText := '';
  FSourceLang := '';
