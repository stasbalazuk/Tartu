...
unit FMX.TMSFNCCloudGoogleTextToSpeech;
...
uses
  Classes, SysUtils, FMX.TMSFNCCloudOAuth, FMX.TMSFNCCloudBase, FMX.TMSFNCTypes, FMX.TMSFNCUtils
  {$IFDEF WEBLIB}
...
constructor TTMSFNCCloudGoogleTextToSpeechVoice.Create(Collection: TCollection);
begin
  inherited;
  FName := EmptyStr;
  FGender := EmptyStr;
